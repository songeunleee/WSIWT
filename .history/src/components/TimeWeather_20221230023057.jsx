...
export default function TimeWeather({ data }) {
  ...
  return (
    <section
      onClick={handleClick}
      className="flex bg-color4 rounded-lg mb-3 p-2 items-center cursor-pointer hover:ease-in duration-200 hover:scale-102"
    >
      <div className=" bg-color2 rounded-lg  items-center w-1/3 p-1">
