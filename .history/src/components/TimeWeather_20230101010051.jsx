...
export default function TimeWeather({ data }) {
  ...
  return (
    <section
      onClick={handleClick}
      className="flex bg-color2 rounded-lg p-2 items-center cursor-pointer hover:ease-in duration-200 hover:scale-102"
    >
      <div className=" bg-color1 rounded-lg  items-center w-1/4 py-1 pt-2 ">
